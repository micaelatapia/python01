...
while edad != 0 and estudios != 0:
    ...
    if sexo == 2 and edad >= 30 and estudios == 3:
        contHombresTer = contHombresTer + 1
    ...
    if sexo == 1 and edad >= 40 and estudios == 2:
...
print("Porcentaje de hombres mayores a 30 años con estudios terciarios.", contHombresTer / contHombres * 100, "%")
print("Promedio de edad de mujeres mayores a 40 años con estudios secundarios:", acumEdadMujeres / cont_Mujeres, "%")